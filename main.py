...
class ChatBotUI(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.conversation_area.append(f'<span style="color: violet;"\
        > Raoult: Welcome to the chatbot!</span><br><br>')
        #self.conversation_area.setPlainText(f'<span style="color: violet;"\> Raoult: Welcome to the chatbot!</span><br><br>')
