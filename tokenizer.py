...
def addBigram(jprev, jnext, Symbols, Work, Key):
    ...
    Parameters:
        ...
        Symbols (list of lists): List of symbols, where each symbol is a list containing the character.
...
def tokenize(texte, Key):
    ...
    while len(Work) > 0:
        ...
        if txt == txt1 + txt2: # Check if the bigram is correctly formed
            ...
            Symbols[jmin][2] = new_jmax # Set the next index of the first character to skip the merged 
        ...
        # Add predefined tokens at the beginning and end of the token list MODIFIER
        Token = [529, 29989, 326, 29918, 2962, 29989, 29958, 1792, 13] + Token + [13, 29966, 29989, 326, 29918, 0,  13]
